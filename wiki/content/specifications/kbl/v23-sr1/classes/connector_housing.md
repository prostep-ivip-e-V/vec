...
---
<p>Steckergehäuse  Body of the connector with 1-n cavities.  A Connector_housing is a non populated connector, i.e. without addressed/populated cavities.  A Connector_housing without any slot allows for the representation of a connector shell (Mehrfachstecker)</p>
## General Information
