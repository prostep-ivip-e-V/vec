...
|Part_type | [String]({{< relref "string.md" >}}) | 0..1 | <p>The part_type specifies the type of a Co_pack_part. Note: There are no values pre-defined. Special values have to be negotiated between exchange partners.</p> | [Co_pack_part]({{< relref "co_pack_part.md" >}}) |

##  Incoming Relations
|    Type  |   Mult.  |   Role    |   Mult.   |   Description  |
|----------|----------|-----------|-----------|----------------|
| [KBL_container]({{< relref "kbl_container.md" >}}) | 1 | Co_pack_part | 0..* |  |
| [Co_pack_occurrence]({{< relref "co_pack_occurrence.md" >}}) | 1..* | Part | 1 |  |
