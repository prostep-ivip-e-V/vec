...
---
<p> A <i>Fixing </i>is a part of the harness used to fix its (the harness) position on something e.g. the body of a car. The term fixing does not refer to the fact that the part itself is attached in some way to the wiring harness. Such parts (e.g. cable ties, labels, abrasion protections)&#160;have the type <i>Accessory.</i>       </p>
