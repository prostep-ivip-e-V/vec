...
| **Is Abstract**         | false |
| **Derived Classifiers** | [Fuse]({{< relref "fuse.md" >}}) |
...
|----------|----------|-----------|-----------|----------------|
| [KBL_container]({{< relref "kbl_container.md" >}}) | 1 | Component | 0..* |  |
| [Component_occurrence]({{< relref "component_occurrence.md" >}}) | 1..* | Part | 1 |  |
