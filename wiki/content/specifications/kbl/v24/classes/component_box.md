...
|----------|----------|-----------|-----------|----------------|
| [Modular_slot]({{< relref "modular_slot.md" >}}) | 0..* | Allowed_inserts | 0..* |  |
| [KBL_container]({{< relref "kbl_container.md" >}}) |  | Component_box | 0..* |  |
| [Component_box_occurrence]({{< relref "component_box_occurrence.md" >}}) | 0..* | Part | 1 |  |
