...
menu:
  VEC-2.2.0:    
    parent: key-concepts
    identifier: key-concepts/vec-root
    weight: 1001007 

# Prev/next pager order (if `docs_section_pager` enabled in `params.toml`)
weight: 1001007
---
{{< svgfigure src="vec-root.png" width="1177" height="716" caption="VEC-Root" numbered="true" >}}
  {{< svglink relref="../../classes/unit.md" x="770.0" y="302.0" width="139.0" height="82.0" >}}
  {{< svglink relref="../../classes/itemhistoryentry.md" x="546.0" y="386.0" width="142.0" height="70.0" >}}
  {{< svglink relref="../../classes/quantitykind.md" x="889.0" y="400.0" width="158.0" height="82.0" >}}
  {{< svglink relref="../../classes/contract.md" x="987.0" y="183.0" width="161.0" height="82.0" >}}
  {{< svglink relref="../../classes/copyrightinformation.md" x="644.0" y="190.0" width="189.0" height="70.0" >}}
  {{< svglink relref="../../classes/vecversion.md" x="14.0" y="512.0" width="112.0" height="190.0" >}}
  {{< svglink relref="../../classes/partversion.md" x="322.0" y="393.0" width="212.0" height="139.0" >}}
