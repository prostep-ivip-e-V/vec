...
{{< svgfigure src="instances-of-cavity-seals-and-cavity-plugs.png" width="1057" height="530" caption="Instances of Cavity Seals and Cavity Plugs" numbered="true" >}}
  ...
  {{< svglink relref="../../classes/multicavityplugrole.md" x="721.0" y="357.0" width="202.0" height="49.0" >}}
  {{< svglink relref="../../classes/multicavitysealrole.md" x="462.0" y="224.0" width="202.0" height="49.0" >}}
...
{{< / svgfigure >}}
<p> The diagram shows the mapping between the part master data of cavity seals and cavity plugs (partly displayed on the left side)&#160;and the instance specific information (displayed on the right side).      </p>