...
links:
  ...
  - icon_pack: far
    icon: file-code
    name: vec_2.2.0-strict.xsd
    url: "vec_2.2.0-strict.xsd"
  - icon_pack: far
    icon: file-code
    name: vec_2.2.0-ud.xsd (undocumented version)
    url: "vec_2.2.0-ud.xsd"
  - icon_pack: far
    icon: file-code
    name: vec_2.2.0-ud-strict.xsd (undocumented version)
    url: "vec_2.2.0-ud-strict.xsd"        
  - icon_pack: fas
    icon: circle-nodes
    name: vec-2.2.0-ontology.ttl
    url: "vec-2.2.0-ontology.ttl"
  - icon_pack: fas
    icon: circle-nodes
    name: vec-2.2.0-shacl.ttl
    url: "vec-2.2.0-shacl.ttl"    
  - icon_pack: fas
    icon: object-group
    name: vec-2.2.0.mdxml
    url: "vec-2.2.0.mdxml"
weight: 1
---

Version 2.2.0 of the VEC is a larger feature update to the VEC. It contains various new features and improvements in multiple topics driven by the community. 
<!--more-->
