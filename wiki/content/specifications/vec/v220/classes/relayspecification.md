...
|relaisType| [RelaisType]({{< relref "relaistype.md" >}}) | 0..1 | <p> The type of the relay (switching behavior). This is an OpenEnumeration, for values see <i>RelaisType.</i>      </p> | [RelaySpecification]({{< relref "relayspecification.md" >}}) |
