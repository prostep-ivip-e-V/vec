...
menu_name: vec-2.2.0
---
{{< deprecated since="2.2" reason="<p> The <i>InternalComponentConnection</i> has been replaced with the more generic approach of adding a <i>ConnectionSpecification</i> to a E/E component description (see &quot;Internal Connectivity&quot;).      </p>">}}<p> An <i>InternalComponentConnection</i> defines a conductive connection between <i>PinComponents </i>within an <i>EEComponent</i>. Such a connection can be statically permanent or dynamically switch (e.g. by a relais). This behavior can be defined with a <i>SwitchingState</i>.      </p>      <p> The electrical behavior of an <i>InternalComponentConnection </i>can be further specified by a referenced <i>ConductorSpecification.</i>      </p>
