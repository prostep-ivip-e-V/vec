...
menu_name: vec-2.2.0
---
OpenEnumeration to define different mounting possibilities of a grommet onto a wiring harness.
...
| MultiPiece | The grommet consists of multiple parts that are assembled around the harness to create the final appearance. |
