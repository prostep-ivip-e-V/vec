...
| PartMasterTemplate | <p> Documents of this type describe reusable snippets of component master data (e.g. a standard cavities or wire receptions, wires without color or interface definition for E/E&#160;components).      </p> |
| NetworkArchitecture |  |
| SystemSchematic |  |
...
| GeometryTemplate | A <i>GeometryTemplate</i> is a <i>GeometryModelSimplified</i> who's actual appearance can be modified with a set of parameters, e.g. a tube can have a variable length, diameter and deformation. A specific set of parameters is defined in <i>GeometryParameters.</i> |
| GeometryParameters | An actual set of parameters for a <i>GeometryTemplate.</i> |
| MasterDataDefinition | <p> Documents of this type contain master data definitions e.g. list valid <i>UsageNodes</i> or list valid <i>Signals</i>.      </p> |
