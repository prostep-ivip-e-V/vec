...
<table>
    ...
    <tr>
        ...
        <td>N</td>
        <td>0..*</td>
        <td>{{< deprecated since="2.2" reason="Replaced by general concept, see &quot;ReusageSpecification&quot;">}}<p> If this <i>TopologyNode</i> is an instance of another <i>To</i><i>pologyNode </i>that is defined elsewhere (e.g. the topology of an assembly), then the instantiated may be referenced here.      </p></td>
    </tr>
    </tbody>
</table>
