...
<table>
    ...
    <tr>
        <td>switchedLogicalConnections</td>
        ...
        <td>N</td>
        <td></td>
        <td><p> Specifies the <i>Connections</i> in the internal connectivity of the <i>EEComponentSpecification, </i>that are switched by this <i>SwitchingState.</i>      </p></td>
    </tr>
    </tbody>
</table>
