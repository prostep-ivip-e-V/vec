...
menu_name: vec-2.2.0
---
Specifies one outlet of a <i>CableLeadThrough</i>. For most <i>CableLeadThroughs</i>, there will be two.
...
<table>
    ...
    <tr>
        ...
        <td>N</td>
        <td></td>
        <td><p> References the <i>PartRelations</i> that specify supplementary parts for this <i>CableLeadThroughOutlet</i>.      </p></td>
    </tr>
    </tbody>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>1</td>
        <td>Specifies the outlets of a <i>CableLeadThrough.</i></td>
    </tr>
    </tbody>
</table>
