...
<table>
    ...
    <tr>
        ...
        <td>N</td>
        <td>0..*</td>
        <td>{{< deprecated since="2.2.0" reason="Use a cable seal plug as supplementary part instead.">}}<p> References the plugs that are used with this CableLeadThroughReference. This association might be a 150% selection.      </p></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>N</td>
        <td>0..*</td>
        <td>{{< deprecated since="2.2.0" reason="Use a cable seal as supplementary part instead.">}}</td>
    </tr>
    <tr>
