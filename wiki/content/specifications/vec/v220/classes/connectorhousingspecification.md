...
|voltageRange| [ValueRange]({{< relref "valuerange.md" >}}) | 0..1 | {{< deprecated since="2.2.0" reason="Replaced by <i>GeneralTechnicalPartSpecification.VoltageRating</i>.">}}<p> Specifies the allowed voltage range for the connector housing.      </p> | [ConnectorHousingSpecification]({{< relref "connectorhousingspecification.md" >}}) |
...
|lockingType| [ConnectorLockingType]({{< relref "connectorlockingtype.md" >}}) | 0..1 | Defines the type of locking of this connector against its counterpart. | [ConnectorHousingSpecification]({{< relref "connectorhousingspecification.md" >}}) |
...
<table>
    ...
    <tr>
        ...
        <td><a href="{{< relref "referencesurfacedefinition.md" >}}">ReferenceSurfaceDefinition</a></td>
        <td>0..1</td>
        <td>Y</td>
        <td>Y</td>
        <td>N</td>
