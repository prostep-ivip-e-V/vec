...
|insulationPullbackLength| [NumericalValue]({{< relref "numericalvalue.md" >}}) | 0..1 | Defines a partial stripping process in which the insulation is pulled back by the <i>insulationPullbackLength</i> after being cut at the <i>strippingLength</i> and is left on the <i>WireEnd</i> e.g. for logistic reasons. The <i>insulationPullbackLength</i> must be shorter than the strippingLength; otherwise, it would not qualify as partial stripping. | [WireEnd]({{< relref "wireend.md" >}}) |
