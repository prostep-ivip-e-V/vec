...
<table>
    ...
    <tr>
        ...
        <td>N</td>
        <td>0..*</td>
        <td>{{< deprecated since="2.2.0" reason="Redundant to WireElement->SubWireElement (exists for historical reasons and reuse of complex wire structures is not recommended).">}}<p> Specifies the contained subWireElements if the WireElement has sub elements. If a <i>WireElementSpecification </i>contains the same <i>WireElementSpecification </i>multiple times, then it shall be referenced as often as it occurs in the reality. Otherwise, the <i>WireElementSpecification </i>wouldn't specify a wire element unambiguously, because the representation in the model would be the same, regardless of the number of sub elements. Therefore, this association must not be realized with a &quot;set&quot; semantic.      </p></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td>0..*</td>
        <td>{{< deprecated since="2.2.0" reason="Redundant to WireSpecification->WireElement->WireElementSpecification (exists for historical reasons).">}}<p> References the <i>WireElementSpecification </i>that defines the properties of the top-most <i>WireElement.</i>      </p></td>
    </tr>
    <tr>
        <td>wireElementSpecification</td>
        <td>1</td>
