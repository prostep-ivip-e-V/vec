...
|voltageRating| [NumericalValue]({{< relref "numericalvalue.md" >}}) | 0..1 | {{< deprecated since="2.2.0" reason="Replaced by <i>GeneralTechnicalPartSpecification.VoltageRating</i>.">}}The <i>voltageRating</i> of an <i>EEComponentSpecification</i> indicates the maximum voltage of the circuit for which the E/E component (e.g. a fuse)&#160;is designed to operate safely. | [EEComponentSpecification]({{< relref "eecomponentspecification.md" >}}) |
...
|characteristic| [FuseCharacteristic]({{< relref "fusecharacteristic.md" >}}) | 0..1 | The characteristics of a fuse design refers to how rapidly the fuse responds to various current overloads. | [FuseSpecification]({{< relref "fusespecification.md" >}}) |
