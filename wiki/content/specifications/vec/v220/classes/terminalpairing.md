...
menu_name: vec-2.2.0
---
<p> A <i>TerminalPairing</i> is a standard reference setup of exactly two terminals and a defined length of a core contacted to both terminals. The <i>TerminalPairing </i>defines physical properties that apply to this combination (e.g. <i>contactResistance)</i>. Other values might be independent from a specific conductor (e.g. <i>matingForce</i>).&#160;Therefore, the <i>referencedCoreSpecification</i> is optional.      </p>      <p> &#160;      </p>      <p> &#160;      </p>
...
|matingCycles| [Integer]({{< relref "integer.md" >}}) | 0..1 | The maximum number of mating cycles, this terminal combination is certified for. | [TerminalPairing]({{< relref "terminalpairing.md" >}}) |
