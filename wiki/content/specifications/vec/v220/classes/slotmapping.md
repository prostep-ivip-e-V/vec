...
|layoutIdentificationA| [String]({{< relref "string.md" >}}) | 0..1 | <p> The identification of a ModularSlotLayout, if the Slot on side A refers to a <i>ModularSlot.</i>      </p> | [SlotMapping]({{< relref "slotmapping.md" >}}) |
|layoutIdentificationB| [String]({{< relref "string.md" >}}) | 0..1 | <p> The identification of a ModularSlotLayout, if the Slot on side B refers to a <i>ModularSlot.</i>      </p> | [SlotMapping]({{< relref "slotmapping.md" >}}) |
