...
| Overlap | <p> <i>Overlap</i> describes a taping where each round overlaps the preceding round.      </p> |
| DoubleOverlap | <p> <i>DoubleOverlap</i> describes a taping where each round overlaps the preceding round and the taping is done twice (forward and backwards).      </p> |
