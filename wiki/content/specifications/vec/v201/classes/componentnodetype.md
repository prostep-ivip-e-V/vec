...
| Lamp | {{< deprecated >}}<p> <i>Deprecated since VEC V1.2. </i>Use ComponentNodeType &quot;Actuator&quot; instead and ComponentSubType <i>Lamp</i>.      </p> |
| Relay | {{< deprecated >}}<p> <i>Deprecated since VEC V1.2. </i>Use instead ComponentSubType Relay.&#160;      </p> |
| Fuse | {{< deprecated >}}<p> <i>Deprecated since VEC V1.2. </i>Use instead ComponentSubType Fuse.&#160;      </p> |
