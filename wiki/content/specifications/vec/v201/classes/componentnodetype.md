...
| {{< deprecated since="[]" reason="[]">}}Lamp | <p> <i>Deprecated since VEC V1.2. </i>Use ComponentNodeType &quot;Actuator&quot; instead and ComponentSubType <i>Lamp</i>.      </p> |
| {{< deprecated since="[]" reason="[]">}}Relay | <p> <i>Deprecated since VEC V1.2. </i>Use instead ComponentSubType Relay.&#160;      </p> |
| {{< deprecated since="[]" reason="[]">}}Fuse | <p> <i>Deprecated since VEC V1.2. </i>Use instead ComponentSubType Fuse.&#160;      </p> |
