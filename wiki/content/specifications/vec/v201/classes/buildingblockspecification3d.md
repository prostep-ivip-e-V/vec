...
| [TopologyZone]({{< relref "topologyzone.md" >}}) | topologyZone | 0..1 | 0..* | <p> References the Zone that is building block represents. This shall be a TopologyZone with the type &quot;DmuZone&quot;.      </p> |
...
| [CartesianPoint3D]({{< relref "cartesianpoint3d.md" >}}) | cartesianPoint | 0..* | 0..1 | Specifies the CartesianPoint3Ds that are used in the BuildingBlockSpecification3D. |
##  Incoming Relations
