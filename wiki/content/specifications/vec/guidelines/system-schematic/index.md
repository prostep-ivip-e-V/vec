...
The mapping of this advanced schematic example into the VEC context it is the following (see [this diagram]({{< relref "#figure-advanced-system-schematic-example" >}})). 
  ...
  - The "virtual" component node shall be marked with the {{< vec-class ComponentNodeType>}} literal *OpenLink* (see [on the right]({{< relref "#figure-open-enumeration-with-openLink" >}})).
