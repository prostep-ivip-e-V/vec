...
|documentType | [String]({{< relref "string.md" >}}) | 0..1 | <p>The type of the document. This should be an enumeration of values defined in a conformance class. Typical values would be example: WiringDiagram, HarnessDrawing, etc. </p> | [DocumentVersion]({{< relref "documentversion.md" >}}) |
