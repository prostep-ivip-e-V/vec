...
|applianceType | [PinApplianceType]({{< relref "pinappliancetype.md" >}}) | 0..1 | <p> Specifies the <i>PinApplianceType</i> of the <i>PinComponent</i>.      </p> | [PinComponentBehavior]({{< relref "pincomponentbehavior.md" >}}) |
