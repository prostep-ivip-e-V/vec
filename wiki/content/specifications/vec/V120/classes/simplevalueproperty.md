...
weight: 
---
<html><body><p>A custom property with a simple value (string). </p></body></html>
## General Information
...
|value | [String]({{< relref "string.md" >}}) | 1 | <html>   <head>     </head>   <body>     <p> Defines the value of the <i>CustomProperty.</i>      </p>    </body> </html>  | [SimpleValueProperty]({{< relref "simplevalueproperty.md" >}}) |
