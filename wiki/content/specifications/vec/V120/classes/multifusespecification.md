...
|fuseType | [String]({{< relref "string.md" >}}) | 0..1 | <html><body><p>The type of a fuse. This should be an enumeration of values defined in a conformance class.  </p></body></html> | [MultiFuseSpecification]({{< relref "multifusespecification.md" >}}) |
|iMaxTotal | [NumericalValue]({{< relref "numericalvalue.md" >}}) | 0..1 | <html>   <head>     </head>   <body>     <p> Specifies the maximum electric current tolerated by the multifuse in total.      </p>    </body> </html>  | [MultiFuseSpecification]({{< relref "multifusespecification.md" >}}) |
