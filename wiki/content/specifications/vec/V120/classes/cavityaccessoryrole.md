...
weight: 
---
<html>   <head>     </head>   <body>     <p> A <i>CavityAccessoryRole</i> defines the instance specific properties and relationships of a cavity accessory.      </p>    </body> </html> 
## General Information
...
|----------|----------|-----------|-----------|-----------------|
| [CavityAccessorySpecification]({{< relref "cavityaccessoryspecification.md" >}}) | cavityAccessorySpecification | 1 | 0..* |  |
##  Incoming Relations
|    Type  |   Mult.  |   Role    |   Mult.   |   Description  |
|----------|----------|-----------|-----------|----------------|
| [CavityMounting]({{< relref "cavitymounting.md" >}}) | 0..* | cavityAccessory | 0..* |  |
