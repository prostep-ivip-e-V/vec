...
weight: 
---
<html><body><p>The ImperialUnit class can define quantities in the terms of the Imperial-Unit-System by specifying the corresponding Imperial unit name. </p></body></html>
## General Information
...
|imperialUnitName | [ImperialUnitName]({{< relref "imperialunitname.md" >}}) | 1 | <html>   <head>     </head>   <body>     <p> Specifies the name of the imperial unit.      </p>    </body> </html>  | [ImperialUnit]({{< relref "imperialunit.md" >}}) |
