...
|----------|----------|-----------|-----------|----------------|
| [CableDuctRole]({{< relref "cableductrole.md" >}}) | 0..* | cableDuctSpecification | 1 | <p> References the <i>CableDuctSpecification</i> that is instanced by this <i>CableDuctRole.</i>      </p> |
