...
|aliasId| [AliasIdentification]({{< relref "aliasidentification.md" >}}) | 0..* | <p> Specifies additional identifiers for the element.      </p> | [PinComponentBehavior]({{< relref "pincomponentbehavior.md" >}}) |
