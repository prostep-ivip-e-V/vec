...
|cutOnWave| [Boolean]({{< relref "boolean.md" >}}) | 0..1 | Defines if the corrugated pipe is cut on top of the corrugation.&#160;This applies only to corrugated pipes that have a defined length. For bulk material in the cutting is defined in the <i>CorrugatedPipeRole.</i> | [CorrugatedPipeSpecification]({{< relref "corrugatedpipespecification.md" >}}) |
