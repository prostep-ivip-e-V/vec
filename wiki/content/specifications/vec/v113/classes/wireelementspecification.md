...
|shape | [WireElementShape]({{< relref "wireelementshape.md" >}}) | 0..1 | <p> Defines the shape of an <i>WireElement. </i>Circular wire elements are defined by their outsideDiameter, all others are defined by their size.      </p> | [WireElementSpecification]({{< relref "wireelementspecification.md" >}}) |
