...
|applianceType | [PinApplianceType]({{< relref "pinappliancetype.md" >}}) | 0..1 | Classifies the appliance of a Pin in terms of the duration of the appliance (see PinApplianceType). | [PinComponentBehavior]({{< relref "pincomponentbehavior.md" >}}) |
