...
|boltDiameter | [NumericalValue]({{< relref "numericalvalue.md" >}}) | 0..1 | <p> Specifies the diameter of the bolt for which the ring terminal is designed for.      </p> | [RingTerminalSpecification]({{< relref "ringterminalspecification.md" >}}) |
...
|boltType | [String]({{< relref "string.md" >}}) | 0..1 | <p> Specifies the type of the bolt. This should be an enumeration of values defined in a conformance class.      </p> | [RingTerminalSpecification]({{< relref "ringterminalspecification.md" >}}) |
